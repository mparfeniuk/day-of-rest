...
І відпочили вони, роздумуючи разом про бренність буття.`,
      ...
      },
      {
        ...
        title: "Роздуми",
        overlayText:
          "Дівчинка спостерігає, як війна нищить те, що люди будували поколіннями. Для якихось країв це — лишекартини в музеях, а для мого — це жорстока правда сьогодення.",
      },
      {
        id: "fourth",
        title: "",
